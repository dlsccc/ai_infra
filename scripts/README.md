...
3. 推荐使用 `ai_infra` 环境解释器运行 Python：
   - `C:\Users\dls\.conda\envs\ai_infra\python.exe`
...
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" src/benchmark/pytorch_baseline.py --config experiments/configs/week01_resnet_cpu.yaml
```

GPU:
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" src/benchmark/pytorch_baseline.py --config experiments/configs/week01_resnet_gpu.yaml
```
...
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" src/benchmark/bert_tokenization_baseline.py --config experiments/configs/week01_bert_cpu.yaml
```

GPU:
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" src/benchmark/bert_tokenization_baseline.py --config experiments/configs/week01_bert_gpu.yaml
```
...
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" scripts/report/generate_week01_rows.py --mode resnet
```

仅 BERT：
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" scripts/report/generate_week01_rows.py --mode bert
```

ResNet + BERT：
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" scripts/report/generate_week01_rows.py --mode all
```
...
```powershell
$env:PYTHONNOUSERSITE='1'
& "C:\Users\dls\.conda\envs\ai_infra\python.exe" scripts/report/generate_week01_rows.py --mode all --out docs/reports/week01_auto_rows.md
```
...
1. `ModuleNotFoundError` 或包版本错乱
   - 先确认解释器是否为 `ai_infra`：
     - `& "C:\Users\dls\.conda\envs\ai_infra\python.exe" -V`
